...
<body>
    ...
    <%
            ...
            out.println("<h1>View Venue Booking record</h1>");
            ...
            for (int i = 0; i < venues.size(); i++) {
                ...
                out.println("<td><a href=\"handleReport?action=list&venue_id=" + v.getId() + "\">View Booking record</a></td>");
                out.println("</tr>");
            }
            out.println("</table>");
        %>
        
        <form action="handleReport" method="get">
            <input type="hidden" name="action" value="income"/>
            <input name="id" type="hidden" value="" readonly/><br/>
            from: <input type="date" name="startmonth"/><br/>
            to: <input type="date" name="endmonth"/>
            <br/><br/>
