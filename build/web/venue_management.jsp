...
<title>EPL Venue Booking System - Venue Management</title>
</head>
<body>
    
    <%
            ArrayList<Venue> venues = (ArrayList<Venue>)request.getAttribute("venues");
            out.println("<h1>Venue Management</h1>");
            out.println("<table border='1' >");
            out.println("<tr>");
            out.println("<th>Name</th><th>Type</th><th>Capacity</th><th>Location</th><th>Description</th><th>Person-in-charge</th><th>Booking Fee</th><th>Enabled</th><th>Actions</th>");
            out.println("</tr>");
            ...
            for (int i = 0; i < venues.size(); i++) {
                ...
                if(v.getEnabled() == true){
                    out.println("<td>v</td>");
                }else{
                    out.println("<td>x</td>");
                }
                out.println("<td><a href=\"handleVenue?action=delete&id=" + v.getId() + "\">Delete</a></td>");
                out.println("<td><a href=\"handleVenue?action=getEditVenue&id=" + v.getId() + "\">Edit</a></td>");
                out.println("</tr>");
            }
            out.println("</table>");
        %>
        <a href="editVenue.jsp">Add new Venue</a><p><a href="HomePage.jsp">Back to home page</a></p>
    <%--<table>
        <thead>
            <tr>
                <th>Name</th>
