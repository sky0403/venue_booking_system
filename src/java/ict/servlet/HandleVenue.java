...
public class HandleVenue extends HttpServlet {
    ...
    public void init(){
        ...
        user = new userDB(dbUrl,dbUser,dbPassword);
    }
    ...
    protected void processRequest(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException{
        ...
        if("list".equalsIgnoreCase(action)){
            ...
            rd  = getServletContext().getRequestDispatcher("/venue_management.jsp");
            ...
            if(id!=null){
                ...
                boolean isDeleted = venue.delvenue(venue_id);
            ...
            if(id!=null){
                ...
                ArrayList<UserInfo> users = user.queryStaff();
            ...
            ArrayList<Venue> venues = venue.queryVenueByEnabled();
            request.setAttribute("venuesEnable", venues);
            RequestDispatcher rd;
            rd  = getServletContext().getRequestDispatcher("/venue_list.jsp");
            rd.forward(request,response);
        }else if("report".equalsIgnoreCase(action)){
            ArrayList<Venue> venues = venue.queryVenue();
            request.setAttribute("venues", venues);
            RequestDispatcher rd;
            rd  = getServletContext().getRequestDispatcher("/venue_search_list.jsp");
            rd.forward(request,response);
        }
